"""
Exercise 04: Testing Patterns

Topics covered:
- Writing testable functions with clear contracts
- Testing for correct results and edge cases
- Testing that exceptions are raised properly
- Parametrize-style testing (loop over test cases)

Instructions:
    Implement each function and class below. Each raises NotImplementedError
    until you provide an implementation. Run the file to verify your solutions
    against the assert-based tests at the bottom.

    The tests in this file demonstrate patterns you would use with pytest:
    - Basic assertions for correctness
    - Testing exceptions with try/except
    - Parametrize-style loops over test cases
    - Edge case testing
"""
...
def calculate_statistics(numbers: list[float]) -> dict[str, float]:
    ...
    """
    raise NotImplementedError("Implement calculate_statistics")
...
def parse_email(email: str) -> tuple[str, str]:
    ...
    """
    raise NotImplementedError("Implement parse_email")
