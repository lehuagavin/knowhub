"""
Exercise 01: Descriptors

Topics covered:
- Descriptor protocol (__get__, __set__, __set_name__)
- Data descriptors for attribute validation
- Building reusable validation logic with descriptors

Instructions:
    Implement each class below. Each method raises NotImplementedError until
...
class Validated:
    ...
    def __init__(self, name: str, validator: callable, error_msg: str = "Invalid value"):
        raise NotImplementedError("Implement Validated.__init__")

    def __set_name__(self, owner, name):
        raise NotImplementedError("Implement Validated.__set_name__")

    def __get__(self, obj, objtype=None):
        raise NotImplementedError("Implement Validated.__get__")

    def __set__(self, obj, value):
        raise NotImplementedError("Implement Validated.__set__")
...
class Bounded:
    ...
    def __init__(self, name: str, min_val: float, max_val: float):
        raise NotImplementedError("Implement Bounded.__init__")

    def __set_name__(self, owner, name):
        raise NotImplementedError("Implement Bounded.__set_name__")

    def __get__(self, obj, objtype=None):
        raise NotImplementedError("Implement Bounded.__get__")

    def __set__(self, obj, value):
        raise NotImplementedError("Implement Bounded.__set__")
