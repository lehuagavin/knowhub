...
Topics covered:
- Custom metaclasses inheriting from type
- Automatic class registration via metaclass
- Enforcing class structure at definition time

Instructions:
    Implement each metaclass and class below. Each raises NotImplementedError
...
class RegistryMeta(type):
    ...
    def __new__(mcs, name, bases, namespace):
        raise NotImplementedError("Implement RegistryMeta.__new__")
...
class ValidatedMeta(type):
    ...
    def __new__(mcs, name, bases, namespace):
        raise NotImplementedError("Implement ValidatedMeta.__new__")
