...
Instructions:
    Implement each async function below. Each raises NotImplementedError until
...
async def fetch_data(url: str, delay: float = 0.01) -> dict:
    ...
    Returns:
        {"url": url, "status": 200}
    """
    raise NotImplementedError("Implement fetch_data")
...
async def gather_results(urls: list[str]) -> list[dict]:
    ...
    """
    raise NotImplementedError("Implement gather_results")
...
async def producer_consumer(items: list, process_func) -> list:
    ...
    """
    raise NotImplementedError("Implement producer_consumer")
...
async def timeout_fetch(url: str, timeout: float = 0.05) -> dict | None:
    ...
    """
    raise NotImplementedError("Implement timeout_fetch")
