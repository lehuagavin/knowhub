...
def save_json(data: dict, filepath: str) -> None:
    ...
    """
    raise NotImplementedError("Implement save_json")
...
def load_json(filepath: str) -> dict:
    ...
    """
    raise NotImplementedError("Implement load_json")
...
def records_to_csv(records: list[dict], filepath: str) -> None:
    ...
    """
    raise NotImplementedError("Implement records_to_csv")
...
def csv_to_records(filepath: str) -> list[dict]:
    ...
    """
    raise NotImplementedError("Implement csv_to_records")
...
if __name__ == "__main__":
    ...
    print("All ex04_json_csv tests passed!")
